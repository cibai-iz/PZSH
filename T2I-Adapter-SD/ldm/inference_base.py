...
def get_base_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--prompt',
        type=str,
        # default='/hdd/zh/Hash/DeepHash-pytorch-master/data/AWA/JPEGImages/SD14_adapter_formatted_prompt.txt',  # AWA
        # default = '/hdd/zh/Hash/DeepHash-pytorch-master/data/CUB/CUB-last50_is_txt2img/attributes/cub_SD14_adapter_path_and_prompt.txt',  # CUB
        # nargs='?',
        default=None,
    ...
    parser.add_argument(
        '--cond_inp_type',
        type=str,
        # default='image',  # 如果输入raw mage,就自动选择合适的adapter处理这个图像,也可以直接填color表明传入的图像是颜色图
        default= 'color',
    ...
    parser.add_argument(
        '--sd_ckpt',
        type=str,
        default='/hdd/zh/Hash/sd_hash/SD14/models/ldm/stable-diffusion-v1/model.ckpt',
    ...
    parser.add_argument(
        '--adapter_ckpt',
        type=str,
        default='/hdd/zh/Hash/sd_hash/SD14/T2I-Adapter-SD/models/t2iadapter_color_sd14v1.pth',
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='/hdd/zh/Hash/sd_hash/SD14/T2I-Adapter-SD/configs/stable-diffusion/sd-v1-inference.yaml',
    ...
    parser.add_argument(  # 在 diffusion 推理过程中，从总采样步数中占多大比例的前段时间应用 Adapter 控制信息。
        '--cond_tau',
        type=float,
        default=1.0,
