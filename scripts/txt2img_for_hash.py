...
def main():
    ...
    # 解析输入参数
    parser.add_argument("--prompt", type=str, default="a painting of a virus monster playing guitar", help="输入的文本提示词")
    ...
    print(f"你的图像已保存在: \n{opt.outdir}\n耗时 {toc - tic:.2f} 秒，祝你愉快！")

# 程序入口
if __name__ == "__main__":
    main()

# python scripts/txt2img_for_hash.py --prompt "a dog is in the bed" --plms